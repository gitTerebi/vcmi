...
EShortcut ShortcutHandler::findShortcut(const std::string & identifier ) const
{
	static const std::map<std::string, EShortcut> shortcutNames = {
		...
		{"adventureEnterNextTown",   EShortcut::ADVENTURE_ENTER_NEXT_TOWN },
		...
		{"adventureScrollMapUp",     EShortcut::ADVENTURE_SCROLL_MAP_UP   },
		{"adventureScrollMapDown",   EShortcut::ADVENTURE_SCROLL_MAP_DOWN },
		{"adventureScrollMapLeft",   EShortcut::ADVENTURE_SCROLL_MAP_LEFT },
		{"adventureScrollMapRight",  EShortcut::ADVENTURE_SCROLL_MAP_RIGHT},
